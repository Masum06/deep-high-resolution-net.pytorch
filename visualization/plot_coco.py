...
point_color2 = [(240,2,127),(240,2,127),(240,2,127), 
            ...
            (255,255,0),(169, 209, 142), (252,176,243),
            (0,176,240),(252,176,243), (0,176,240),
            (252,176,243),(0,176,240), (255,255,0),
            (169, 209, 142), (255,255,0),(169, 209, 142),
    ...
    for catId in catIds:
        for imgId in p.imgIds[:5000]:
            ...
            if save:
                ...
                plt.savefig(save_path +'id_'+str(imgId)+ '.png', format='png', 
